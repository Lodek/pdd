...
A Bus update notifies Updater by appending to the handle list.
Updater can be called to handle the events which in turn updates circuits.
That initiates a cascate of Bus events. Updater's job for the cycle is done when
